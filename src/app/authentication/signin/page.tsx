    ...
    <div className="w-screen h-screen flex flex-col items-center justify-center">
      <div className="flex flex-col gap-20">
        ...
        <div className="flex gap-52 ">
          <div className="flex flex-col items-center justify-center p-4 gap-4 w-[440px] h-[267px] ">
            <Input
              type="text"
          ...
          <div className="flex flex-col  p-4 items-center gap-4 w-[440px] h-[267px]">
            <div className="text-center">
